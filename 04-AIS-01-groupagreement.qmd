...
- DO: Create a Microsoft Planner with all members of your group to assign individual tasks (we recommend copying [this Planner template for the stage 1 group report](https://tasks.office.com/gla.onmicrosoft.com/Home/PlanViews/p_04y5UClU-Hq1qwx0gN65YACpzm?Type=PlanLink&Channel=Link&CreatedTime=638616394371860000){target="_blank"} we have created. Please copy the Planner, do not edit it.).
...
- DO: Consult the [Stage 1 group work planning advice section below](#stageone-planning) to identify the strengths/preferences of your team.
...
As you start working in your groups, one key decision will be sharing out the tasks equitably. In the stage 1 report template, there are several sections and sub-sections to complete. For each component, try to summarise the following when you first meet with your group:
...
You might choose to separate the tasks differently, but this is one suggestion to work through. We support this [the Planner template for the stage 1 group report](https://tasks.office.com/gla.onmicrosoft.com/Home/PlanViews/p_04y5UClU-Hq1qwx0gN65YACpzm?Type=PlanLink&Channel=Link&CreatedTime=638616394371860000){target="_blank"}, so we recommend at least starting with this plan and allocate roles, and then adapt as you need. 
