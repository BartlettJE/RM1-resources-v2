...
An additional resource we will link to time to time is [A Handy Workbook for Research Methods & Statistics](https://psyteachr.github.io/handyworkbook/index.html){target="_blank"}. From around week 6, we will introduce you to inferential statistics. When you use these practically, you will use R/RStudio to efficiently analyse larger amounts of data. In the Handy Workbook, we work through step-by-step how these statistical tests work, so you can gain a better understanding of what numbers go in, what happens to those numbers, and what numbers come out. 

## Course reading list

To support each week, there is a course reading list which is linked on the Moodle page, but you can access it by [following this link](https://rl.talis.com/3/glasgow/lists/0A7B1002-735E-2ACF-E3E4-D0EC205FFE19.html){target="_blank"}. We appreciate you only have so much time each week and have other courses to complete, so the resources are labelled as essential, recommended, and further. 
